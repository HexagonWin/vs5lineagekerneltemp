...
// Header for PANTECH CAMERA kanged from other file.
...
/* This part is now replaced by the code below from Pantech
...
/* The following is now replaced by the code from pantech
*/
